...
const devIIFE = merge(baseJS, {
    output: {
        file: 'dist/flexlar-datatable.js',
        format: 'iife',
        name: 'DataTable'
    }
});
...
const devCjs = merge(baseJS, {
    output: {
        file: 'dist/flexlar-datatable.cjs.js',
        format: 'cjs'
    }
});
...
const devCSS = merge(baseCSS, {
    output: {
        file: 'dist/flexlar-datatable.css',
        format: 'cjs'
    }
});
...
const prodIIFE = merge(devIIFE, {
    output: {
        file: 'dist/flexlar-datatable.min.js'
    },
    plugins: [
        uglify()
    ]
...
const prodCSS = merge(devCSS, {
    output: {
        file: 'dist/flexlar-datatable.min.css'
    }
});
